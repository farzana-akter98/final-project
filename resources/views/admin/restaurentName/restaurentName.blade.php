        ...
        <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
            <div class="mdl-card mdl-shadow--2dp">
                ...
                <div class="form__action mdl-card__title">
                    <a href="{{action('Admin\RestaurentNameController@create')}}" id="submit_button" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored">
                        Create Restaurent Name
                    </a>
                </div>
