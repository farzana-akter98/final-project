        ...
        <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
            <div class="mdl-card mdl-shadow--2dp">
                <div class="mdl-card__title">
                    <h1 class="mdl-card__title-text">Grocery Shop Table</h1>
                </div>
                <div class="form__action mdl-card__title">
                    <a href="{{action('Admin\GroceryShopController@create')}}" id="submit_button" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored">
                        Create Grocery Shop
                    </a>
                </div>
                <div class="mdl-card__supporting-text no-padding">
                    <table class="mdl-data-table mdl-js-data-table stripped-table">
                        ...
                        <tr>
                            ...
                            <th class="mdl-data-table__cell--non-numeric">Grocery Shop Name</th>
                            <th class="mdl-data-table__cell--non-numeric">Grocery Shop Address</th>
