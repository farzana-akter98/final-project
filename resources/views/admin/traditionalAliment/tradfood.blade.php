                    ...
                    <table class="mdl-data-table mdl-js-data-table stripped-table">
                        ...
                        <tbody>
                         ...
                         <tr>
                            ...
                            @endif</td>
                            <td class="mdl-data-table__cell--non-numeric"><span class="label"><a href="{{action('Admin\TraditionalAlimentController@update_page',['id'=> $item->id])}}">Update</a></span><span><a href="{{action('Admin\TraditionalAlimentController@delete',['id'=> $item->id])}}" class="delete_a">Delete</a></span></td>
                        </tr> 
                         @endforeach
